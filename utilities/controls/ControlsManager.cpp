...
void ControlsManager::init(SDL_Window* sdlWindow) {
...
void ControlsManager::processEvents(const SDL_Event* ev) {
	switch(ev->type) {
    case SDL_QUIT:
      this->gameIsRunning = false;
      break;
...
void ControlsManager::handleKeyDown(const SDL_Event* ev) {
...
void ControlsManager::handleMouse(const SDL_Event* ev) {
...
void ControlsManager::handleMouseWheel(const SDL_Event* ev) {
	this->mouseWheel.x = 0;
	this->mouseWheel.y = 0;
...
void ControlsManager::handleMouseMotion(const SDL_Event* ev) {
