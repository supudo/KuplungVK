...
void ConfigUtils::init(std::string const& appFolder) {
  ...
  this->recentFilesFile = appFolder + "/KuplungVK_RecentFiles.ini";
  this->recentFilesFileImported = appFolder + "/KuplungVK_RecentFilesImported.ini";
...
void ConfigUtils::saveSettings() {
  ...
  if (!out.is_open())
    throw std::runtime_error("[KuplungVK] Unable to save settings file!");
